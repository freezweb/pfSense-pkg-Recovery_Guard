...
final class NotificationOutbox
{
    ...
    public static function emptyState(): array { return ['version' => 1, 'last_time' => 0, 'overflow_attempts' => 0, 'items' => []]; }
    ...
    public function enqueue(string $target, array $event): bool
    {
        ...
        return $this->store->exclusive(function ($s) use ($id, $target, $event): bool {
    ...
    {
        if (array_keys($s) !== ['version', 'last_time', 'overflow_attempts', 'items'] || $s['version'] !== 1 ||
