...
Remaining work includes native repair and reboot integration, native pfSense notification and reboot-observation validation, native interlock coordination, live GUI and lifecycle validation, isolated pfSense failure/reboot tests and current development-version validation. See [acceptance tracking](docs/ACCEPTANCE.md).
